...
namespace MidiPlayerTK
{
    ...
    public class MidiFilePlayer : MidiPlayer
    {
        ...
        [SerializeField]
        [HideInInspector]
        private bool playOnStart = false, newMidiToPlay = false, stopMidiToPlay = false, midiIsPlaying = false, loop = false, playPause = false, logEvents = false, sendNotes = true;
        ...
        private IEnumerator ThreadPlay()
        {
            midiIsPlaying = true;
            ...
            try
            {
                ...
                miditoplay = new MidiLoad(mididata.bytes, logEvents);
            }
            catch (System.Exception ex)
            {
                MidiPlayerGlobal.ErrorDetail(ex);
            ...
            if (miditoplay != null)
            {
                ...
                do
                {
                    miditoplay.LogEvents = logEvents;
