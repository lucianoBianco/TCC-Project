...
namespace MidiPlayerTK
{
    ...
    public class MidiPlayer : MonoBehaviour
    {
        ...
        /// <summary>
        /// Time in second to stop a sound after the Duration time. No effect on sound with no loop as Drum.
        /// </summary>
            ...
            try
            {
                ...
                if (smpl != null)
                {
                    ...
                    if (clip != null && clip.loadState == AudioDataLoadState.Loaded)
                    {
                        ...
                        // Play note
                        StartCoroutine(PlayNote(audioSelected, !note.Drum, note, timeToRelease));
        ...
        /// <param name="note"></param>
        /// <returns></returns>
        protected IEnumerator PlayNote(AudioSource audio, bool loop, MidiNote note, float vTransitionTime)
        {
            if (note.Delay > 0f)
            {
