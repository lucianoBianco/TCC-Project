        ...
        public override void OnInspectorGUI()
        {
            try
            {
                ...
                if (MidiPlayerGlobal.CurrentMidiSet != null && MidiPlayerGlobal.CurrentMidiSet.ActiveSounFontInfo != null)
                {
                    ...
                    if (showMidiInfo)
                    {
                        EditorGUILayout.LabelField("Sequence", instance.MPTK_SequenceTrackName);//, GUILayout.MinHeight(100));//, GUILayout.Width(30));
                        EditorGUILayout.LabelField("Program", instance.MPTK_ProgramName);
                        EditorGUILayout.LabelField("Instrument", instance.MPTK_TrackInstrumentName);
                        EditorGUILayout.LabelField("TextEvent", instance.MPTK_TextEvent);
                        EditorGUILayout.LabelField("Copyright", instance.MPTK_Copyright);
                    }
